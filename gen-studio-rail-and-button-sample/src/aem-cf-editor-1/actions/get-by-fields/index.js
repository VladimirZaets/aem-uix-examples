  ...
  try {
    ...
    for (const key of searchParamsKeys) {
      ...
      if (criteria) {
        ...
        // if (criteria.field === "countries" && false) {
        //   const responseTranslations = await fetch(`https://restcountries.com/v3.1/name/${criteria.value}?fullText=true`);
        //   d = await responseTranslations.json();
        // } else {
        //
        // }
